...
export default function RegisterForm({
  ...
  const registerSchema = z
    .object({
      ...
      phone: z
        ...
        .max(18, "Phone is to long"),
      role: z.enum(["sender", "receiver"]).refine((val) => !!val, {
        message: "Please select a role (Sender or Receiver)",
      }),
  ...
  const onSubmit: SubmitHandler<IUserPayload> = async (data) => {
    console.log(data);
    try {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    {/* RoleSelect expects value and onChange */}
                    <RoleSelect
